...
// calculado al cerrar: cada venta en efectivo y cada pago de cuenta
// corriente cobrado en efectivo. Componente de servidor puro, igual que
// ListaVentasDelTurno.
export function ListaMovimientosCaja({ movimientos }: { movimientos: MovimientoCaja[] }) {
  return (
