...
// etiqueta) — un solo lugar para no listar los 13 tipos dos veces.
export const INFO_TIPO_AUDITORIA: Record<TipoMovimientoAuditoria, { etiqueta: string; variante: "ok" | "alerta" }> = {
  ...
  cta_cte_actualizacion: { etiqueta: "Actualización de precios", variante: "alerta" },
