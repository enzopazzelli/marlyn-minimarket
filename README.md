...
regla `@media print` en `globals.css`, con el tamaño de página armado
al imprimir según el rollo (ver "Rollo de 58 u 80 mm" abajo) — y
"Descargar" ofrece PNG o PDF con `html-to-image` +
